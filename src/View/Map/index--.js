        ...
        methods: {
            loadTreeNode(node, resolve) {
                ...
                me.$http.post(
                    ...
                    JSON.stringify({parentId: node.data.id}),
                    {emulateJSON: true, emulateHTTP: false}
                ).then(res => {
                    if (res.body.success) {
                        resolve(res.body.model);
                        return;
                    }
            ...
            async handlerSaveTreeNode() {
                ...
                if (me.$refs.tree && me.areaDialogModel.state === 'add') {
                    ...
                    if(res.status === 200 && res.body.success) {
                        ...
                        me.$refs.tree.append(data, res.body.model);
