            ...
            <div class="smart-box smart-box-mechanical" style="transition: all .6s linear; z-index: 999;" :style="{ height: hasExpandDevice ? `${networkMax * 41 + 120}px` : '100%', position : hasExpandDevice ? 'absolute' : 'relative' }">
                ...
                <div class="smart-box-mechanical-inner">
                    <div class="smart-box-mechanical-body" style="padding: 10px 0px; box-sizing:border-box;">
                        <el-row v-for="i in networkMax" type="flex" class="box-device-list"  v-show="hasExpandDevice" justify="center" align="center" :key="i">
                            ...
                            <el-col :span="3" v-for="(vol,index) in devicePower" :key="index" v-show="vol[4]">
                                <div class="box-device-list-setting" >
                                    <el-row type="flex" style="text-align: center; height: 30px; background-color: #006584; line-height: 30px;" justify="center" align="center">
                                        ...
                                        <el-col :span="8">{{vol[1]!==undefined ? Math.floor(Math.round(vol[1]*1000)/1000) : ''}}V</el-col>
                                    ...
                                    <el-row type="flex" style="text-align: center; height: 30px; background-color: #005676; line-height: 30px;" justify="center" align="center">
                                        <el-col :span="8"><i class="el-icon-switch-button" :title="vol[3] ? '点击关闭' : '点击开启'" :class="{ 'smart-box-text-success' : vol[3], 'smart-box-text-dangle' : !vol[3],'smart-box-text-info' : getTransDevStatus(vol[0])}" style="cursor:pointer;font-weight: bold;" @click="getMessage(vol)"></i>{{vol[3] ? '开启' : '关闭'}}</el-col>
                                        <el-col :span="8"><i class="el-icon-refresh-right smart-box-text-warning" style="cursor:pointer;font-weight: bold;" @click="powerReset(vol[0])" title="点击重启"></i>重启</el-col>
                                    </el-row>
                                </div>
                            </el-col>
                        </el-row>
        ...
        <div class="smart-box-flex-column-10 smart-box-flex-column-clear">
            <div class="smart-box smart-box-flex-row">
                ...
                <div ref="device_container" class="smart-box-flex-column-8">
                    <div class="box-device" @click="boxOpen = !boxOpen" :class="{ 'box-is-open' : boxOpen }"><span v-show="!boxOpen">智能监控站</span><pre style="position:absolute;bottom:0px;left:110px;font-size:14px;color:#FFF;">此页面30秒刷新一次，或点此按钮立刻刷新<i class="el-icon-refresh-right smart-box-text-success" style="cursor:pointer;" @click.stop="refreshAllData"></i></pre></div>
                </div>
                <div class="smart-box-flex-column-8">
                    <div class="smart-box smart-box-window" style="height: 100%; padding:10px; box-sizing: border-box;">
                            ...
                            <div class="smart-box-window-body">
                                <el-row class="box-row" type="flex" justify="center" align="center" v-for="([item_1, item_2], rowIndex) in portData" :key="rowIndex">
                                    ...
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="3">
                                        ...
                                        <i class="fa fa-power-off" style="cursor:pointer;" :title="item_1[3]? '关闭' : '开启'" :class="{'smart-box-text-success' : item_1[3],'smart-box-text-dangle' : !item_1[3]}" @click="portSwitchControl(item_1, rowIndex, 0)"></i>
                                    </el-col>
                                    ...
                                    <el-col class="box-col-item" style="padding:10px 0px; text-align:center;" :span="3" :class="{'active' : item_2}">
                                        ...
                                        <i class="fa fa-power-off" style="cursor:pointer;" v-if="item_2" :title="item_2[3]? '关闭' : '开启'" :class="{'smart-box-text-success' : item_2[3],'smart-box-text-dangle' : !item_2[3]}" @click="portSwitchControl(item_2, rowIndex, 1)"></i>
                                    </el-col>
                                </el-row>
                            </div>
                        </div>
                        ...
                        <div class="smart-box-window-inner">
                            ...
                            <div class="smart-box-window-body" style="overflow-y:auto; padding:0px 20px; box-sizing:border-box;">
                                ...
                                <el-row class="box-row" v-for="(item,index) in getMonitoringDataArr" :key="getMonitoringData.length + index" type="flex" justify="center" align="center"  style="width: 50%; margin: 5px 0px; margin-bottom:5px; float:left;">
                                    ...
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="8" :title="item.perform_value">
                                        {{ item.perform_value }}
                                    </el-col>
                                </el-row>
                                <!--能力集不推电压， 特定版本写死的的，现在不需要。-->
                                <!-- <el-row class="box-row" type="flex" justify="center" align="center"  style="width: 50%; margin: 5px 0px; margin-bottom:5px; float:left;">
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="6">
                                        <i class="box-thunderIcon"></i>
                                    </el-col>
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="8" title="电压">
                                        电压
                                    </el-col>
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="8" title="4.98V">
                                        4.98V
                                    </el-col>
                                </el-row> -->
                                <!-- <el-row class="box-row" type="flex" justify="left" align="left" v-for="([item1,item2],index) in monitoringData" :key="index">
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="3">
                                        <i :class="getIconStyle(item1.PERFORM_NAME, item1.PERFORM_VALUE)"></i>
                                    </el-col>
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="4" :title="item1.PERFORM_DESCRIPTION">
                                        {{item1.PERFORM_DESCRIPTION}}
                                    </el-col>
                                    <el-col class="box-col-item active" style="padding:10px 0px; text-align:center;" :span="4" :title="formatter(item1.PERFORM_NAME, item1.PERFORM_VALUE) || item1.PERFORM_VALUEN">
                                        {{ formatter(item1.PERFORM_NAME, item1.PERFORM_VALUE) || item1.PERFORM_VALUE }}
                                    </el-col>
                                    <el-col class="box-col-item" :span="1"></el-col>
                                    <el-col v-if="item2" class="box-col-item" style="padding:10px 0px; text-align:center;" :span="3" :class="{'active' : item2}">
                                        <i :class="getIconStyle(item2.PERFORM_NAME, item2.PERFORM_VALUE)"></i>
                                    </el-col>
                                    <el-col v-if="item2" class="box-col-item" style="padding:10px 0px; text-align:center;" :span="4" :class="{'active' : item2}" :title="item2.PERFORM_DESCRIPTION">
                                        <span>{{item2.PERFORM_DESCRIPTION}}</span>
                                    </el-col>
                                    <el-col v-if="item2" class="box-col-item" style="padding:10px 0px; text-align:center;" :span="4" :class="{'active' : item2}" :title="formatter(item2.PERFORM_NAME, item2.PERFORM_VALUE) || item2.PERFORM_VALUE">
                                        <span>
                                            {{ formatter(item2.PERFORM_NAME, item2.PERFORM_VALUE) || item2.PERFORM_VALUE }}
                                        </span>
                                    </el-col>
                                </el-row> -->
                            </div>
...
<style lang="scss" scoped>
    ...
    .box-device {
        width: 100%;
        height: 100%;
        background-image: url(../../assets/Images/box-close.png);
        ...
        position:relative;
        &.box-is-open {
            background-image: url(../../assets/Images/box-open.png);
